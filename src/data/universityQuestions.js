const universityQuestions = [
  ...
  { id: 'hm_03', universities: ['sanmarcos', 'uni', 'trujillo', 'sanmartin'], subject: 'habilidad matemática', text: 'Si $a\\oplus b = a^2 - b$, calcula $3\\oplus(2\\oplus1)$', opts: ['10', '8', '12', '6'], ans: 3, explanation: '$2\\oplus1=4-1=3$, $3\\oplus3=9-3=6$.' },
  { id: 'hm_04', universities: ['sanmarcos', 'uni', 'trujillo', 'sanmartin'], subject: 'habilidad matemática', text: 'Si $a\\#b = a + b + ab$, halla $2\\#(3\\#1)$', opts: ['15', '17', '19', '23'], ans: 3, explanation: '$3\\#1=3+1+3=7$, $2\\#7=2+7+14=23$.' },
  ...
  { id: 'hm_09', universities: ['sanmarcos', 'uni', 'trujillo'], subject: 'habilidad matemática', text: 'Halla $x$: $3x+5$ es a $x-1$ como 2 es a 1', opts: ['5', '-7', '9', '11'], ans: 1, explanation: '$\\frac{3x+5}{x-1} = \\frac{2}{1} \\Rightarrow 3x+5=2x-2 \\Rightarrow x=-7$.' },
  { id: 'hm_10', universities: ['trujillo', 'sanmartin', 'sanmarcos'], subject: 'habilidad matemática', text: 'Si $\\frac{a}{2} = \\frac{b}{3} = \\frac{c}{4}$ y $a+b+c=36$, halla $b$', opts: ['18', '12', '16', '10'], ans: 1, explanation: '$a=2k$, $b=3k$, $c=4k$. Suma: $9k=36 \\Rightarrow k=4 \\Rightarrow b=12$.' },
